...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/18 10:39:26 by hazaouya          #+#    #+#             */
/*   Updated: 2023/01/18 10:52:17 by hazaouya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define CUBEXT_ERROR "The file you entered is not ending with .cub extension"
# define PARSE_ERROR "Cub3D: Parsing error!"
# define MAP_NOT_VALID_ERROR "Cub3D: Map is not valid!"
# define ARGS_ERROR "please run cub3d as follows: ./cub3d [map_file_path]"
# define MISSING_PLAYER_ERROR "Cub3D: There is no player in the map"
# define MORE_THAN_ONE_PLAYER_ERROR "There is more than one player in the map"
# define PLAYER_HAS_PATH_TO_SPACE "There is a path to a space inside the map"
...
int		check_map(char *line, int *player, int *paraps, int fd);
